...
/**
 * Lists all the participants in a course.
 *
...
if ($mode && $mode == 'brief') {
    $participanttable = new \local_culcourse_dashboard\table\participants("user-index-participants-{$course->id}");
} else {
...
$photoboardtabs = new \local_culcourse_dashboard\output\photoboard_tabs();
